    ...
    <div className="min-h-[calc(100vh-8rem)] bg-slate-100/90 pb-10">
      <div className="mx-auto max-w-4xl px-4 pt-4">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Saving replaces the depreciation sheet for that fiscal year and branch
          scope and recalculates <span className="font-medium">all</span> register
          assets (so new assets appear after you save again).
        </p>
